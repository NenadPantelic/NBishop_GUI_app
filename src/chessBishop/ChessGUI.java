...
public class ChessGUI {
    ...
    private boolean maxSolutionFlag = false;
    private boolean click = false;
    private int comb[][];
    private int localCombination[][];
    ChessGUI() {
    ...
    public final void initializeGui() {
        ...
        Action fullPositionAction = new AbstractAction("Prvo maksimalno resenje") {
    ...
    private final void setupPrevMaxConf(){
    	...
    	if(position <-1 && position >= -nb.getFullCombNum() && click){
    ...
    private final void setupNextMaxConf(){
    	...
    	if(position < 0 && position > -nb.getFullCombNum() && click){
